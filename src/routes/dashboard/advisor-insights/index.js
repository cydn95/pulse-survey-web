...
const AdvisorInsights = ({ surveyId, surveyUserId, actionAdvisorReport }) => {
              ...
              {Object.keys(data.detailedData).map((key) => (
                ...
                >
                  <div className={styles["content-item-question"]}>
                    The teams / groups that feel the most <strong>{key}</strong>{" "}
                  ...
                  <div className={styles["content-item-data"]}>
                    {Object.keys(data.detailedData[key]).map((key2) => (
                      ...
                      >
                        ...
                        <div
                          className={styles["content-item-percent-container"]}
                        >
                          <div
                            className={styles["content-item-percent-bar"]}
                            style={{
                              width: `${
                                (data.detailedData[key][key2].score / 10) * 100
                              }%`,
                            }}
                          ></div>
