      ...
      <div>
        <Row>
          <Colxx xs="12">
            ...
            <textarea
              onClick={(e) => this.onShowSmartList()}
              onChange={(e) => this.onInputSmartText(e)}
            ...
            <Colxx xs="12">
              <div className="smart-list-section">
                <div className="header">
                  <a href="/" onClick={(e) => this.onCloseSmartList(e)}>
                    <FontAwesomeIcon icon="times-circle" /> Hide Autosuggestions
                  </a>
                </div>
                <div className="body">
                  <div className="row-container">
                    <Row className="smart-row">
                      <Colxx className="smart-col2" xs="4">
                        Company
                      </Colxx>
                      <Colxx
                        className="smart-col"
                        xs="8"
                        onClick={(e) => this.onSelectSmart("Microsoft")}
                      >
                        Microsoft
                      </Colxx>
                    </Row>
                  ...
                  <div className="row-container">
                    <Row className="smart-row">
                      ...
                      <Colxx
                        className="smart-col"
                        xs="8"
                        onClick={(e) => this.onSelectSmart("Michale Scott")}
                      >
                        Michale Scott
                      </Colxx>
                    </Row>
                    <Row className="smart-row">
                      ...
                      <Colxx
                        className="smart-col"
                        xs="8"
                        onClick={(e) => this.onSelectSmart("Michale Jefferson")}
                      >
                        Michale Jefferson
                      </Colxx>
                    </Row>
